...
namespace ShoppingCart.Web.Grids
{
    public static class MVCGridProductsConfig
    {
        ...
        private const string FILTER_DESC = "filterDesc";
        ...
        private static IQueryable<ProductItemModel> FilterData(QueryOptions options, IQueryable<ProductItemModel> query, string name, string desc)
        {
        ...
        private static void BuildColumns(GridColumnListBuilder<ProductItemModel> cols)
        {
